...
namespace Fluf
{
	...
	{
		FLUF_ASSERT(index >= 0 && index < m_count, "Index out of range");
	...
	{
		FLUF_ASSERT(m_count > 0, "Index out of range");
		return m_buffer[0];
	}
	...
	{
		FLUF_ASSERT(index >= 0 && index + elements <= m_count, "Index out of range");
